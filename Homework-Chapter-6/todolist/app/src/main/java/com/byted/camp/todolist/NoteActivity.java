...
public class NoteActivity extends AppCompatActivity {
    ...
    private boolean saveNote2Database(String content, Priority priority) {
        ...
        values.put(TodoNote.Content_Attribute, content);
        values.put(TodoNote.Date_Attribute, System.currentTimeMillis());
        values.put(TodoNote.State_Attribute, State.TODO.intValue);
        values.put(TodoNote.Priority_Attribute, priority.intValue);
        long rows = database.insert(TodoNote.Name_Table, null, values);
