...
public class UploadActivity extends AppCompatActivity {
    ...
    private void submit() {
        ...
        MultipartBody.Part _from = MultipartBody.Part.createFormData("from", Constants.USER_NAME);
        ...
        Call<UploadResponse> repo = api.submitMessage(Constants.STUDENT_ID, "", _from,
                _to, _content, coverPart, Constants.token);
        repo.enqueue(new Callback<UploadResponse>() {
            @Override
